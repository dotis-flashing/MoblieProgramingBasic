...
public class TraineeListViewAdapter extends BaseAdapter {
    ...
    private final Exercise1 context;
    private List<Trainee> traineeList;
    private final int rowTraineeLayout;

    public TraineeListViewAdapter(Exercise1 context, List<Trainee> traineeList, int rowTraineeLayout) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        holder.icEdit.setOnClickListener(v -> context.showDialog(Exercise1.DialogType.UPDATE, trainee));
        return view;
    }
}
